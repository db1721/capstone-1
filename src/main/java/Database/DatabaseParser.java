				...
				while (tokenizer.hasMoreTokens()) {
					...
					if (currentToken.equalsIgnoreCase("name:")) {
						if (meal.size() > 0) {
							...
							mealDatabase.addMeal(name, calories, favorite, duplicate, mealOfDay, ingredientCounts,
					...
					else if (currentToken.equalsIgnoreCase("calories:") || currentToken.equalsIgnoreCase("favorite:")
