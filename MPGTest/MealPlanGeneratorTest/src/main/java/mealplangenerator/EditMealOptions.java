...
public final class EditMealOptions extends JFrame{
  ...
  public void editProperties() {
    ...
    try {
      mealToEdit = JOptionPane.showInputDialog(null, "Select a meal to edit.",
      ...
      propertyToEdit = JOptionPane.showInputDialog(null, "Select a property to edit.",
      ...
      if(propertyToEdit.equalsIgnoreCase("favorite") || propertyToEdit.equalsIgnoreCase("duplicate"))
        newPropertyValue = JOptionPane.showInputDialog(null, "What is the new value"
                + "(true or false)?", "").trim();
      else
        newPropertyValue = JOptionPane.showInputDialog(null, "What is the new value?",
          "").trim();
      ...
      if(mealToEdit == null || newPropertyValue == null ||mealToEdit.equals("") 
              || propertyToEdit.equals("") || newPropertyValue.equals(""))
        throw new Exception();       
    }
    catch(Exception e) {
